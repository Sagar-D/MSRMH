...
router.get('/:slno/:daa/:basepay/:approved', function(req, respond, next) {
    ...
    total=parseInt(daa)+parseInt(basepay); //write correct logic
...
function createpdfel(idforrequest)
{
    ...
    details.EL_Balance = 120;
    details.Date_of_previous_encashment = 'First Time';
